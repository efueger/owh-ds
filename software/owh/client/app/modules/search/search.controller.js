(function(){
    ...
    function SearchController($scope, ModalService, utilService, searchFactory, $rootScope,
        ...
        sc.sort = {
            ...
            "label.filter.natality": ['dob_yy', 'dob_mm', 'dob_wk', 'sex', 'gestational_age_r10', 'prenatal_care',
                'birth_weight', 'birth_weight_r4', 'birth_weight_r12', 'birth_plurality', 'live_birth', 'birth_place',
                'delivery_method', 'medical_attendant', 'mother_race', 'hispanic_origin', 'marital_status',
