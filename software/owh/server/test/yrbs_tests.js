...
describe("YRBS API", function () {
    ...
    it("buildYRBSQueries with grouping param", function (){
        ...
        expect(result).to.eql( ['q=qn1&v=race,sex','q=qn2&v=race,sex','q=qn3&v=race,sex']);

    });

    it("buildYRBSQueries with all grouping params", function (){
        var apiQuery = {'aggregations':{'nested':{'table':[{"key":"question","queryKey":"question.key","size":100000},{"key":"yrbsGrade","queryKey":"grade","size":100000},{"key":"yrbsSex","queryKey":"sex","size":100000},{"key":"yrbsRace","queryKey":"race","size":100000},{"key":"yrbsYear","queryKey":"year","size":100000}]}},
                        'query': {'question.path':{ 'value': ['qn1', 'qn2', 'qn3']}}};
        var result = yrbs.buildYRBSQueries(apiQuery);
        expect(result).to.eql( ['q=qn1&v=year,race,grade,sex','q=qn2&v=year,race,grade,sex','q=qn3&v=year,race,grade,sex']);
    ...
    it("buildYRBSQueries with multiple grouping and filtering params", function (){
        ...
        var result = yrbs.buildYRBSQueries(apiQuery);
        expect(result).to.eql( ['q=qn1&v=race,sex&f=race:White,Black or African American;sex:Female','q=qn2&v=race,sex&f=race:White,Black or African American;sex:Female','q=qn3&v=race,sex&f=race:White,Black or African American;sex:Female']);
    ...
    it("processYRBSReponses with multiple groupings result nested in order race, sex", function (){
